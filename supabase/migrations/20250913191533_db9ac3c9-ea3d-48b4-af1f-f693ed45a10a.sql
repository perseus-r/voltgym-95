-- Inserir exercícios reais na tabela exercises (corrigindo ARRAY vazio)
...
('Cadeira Extensora', ARRAY['Quadríceps'], ARRAY['Deltóide']::text[], 'Máquina', ARRAY['Sente na máquina', 'Estenda as pernas', 'Controle a descida'], ARRAY['Movimento controlado', 'Não bata a carga'], 2),
...
('Elevação Lateral', ARRAY['Deltóide médio'], ARRAY['Deltóide']::text[], 'Halteres', ARRAY['Com halteres ao lado do corpo', 'Eleve os braços lateralmente', 'Controle a descida'], ARRAY['Cotovelos levemente flexionados', 'Não use impulso'], 3),
('Elevação Frontal', ARRAY['Deltóide anterior'], ARRAY['Core']::text[], 'Halteres', ARRAY['Com halteres à frente', 'Eleve os braços para frente', 'Controle o movimento'], ARRAY['Não passe da altura dos ombros', 'Core contraído'], 2),
...
('Tríceps Testa', ARRAY['Tríceps'], ARRAY['Peitoral']::text[], 'Barra', ARRAY['Deite no banco', 'Segure a barra acima do peito', 'Flexione apenas os antebraços'], ARRAY['Cotovelos fixos', 'Movimento isolado do tríceps'], 3),
