-- CRIAÇÃO DAS POLÍTICAS RLS (removendo conflitos primeiro)
...
DROP POLICY IF EXISTS "Exercise categories are viewable by everyone" ON public.exercise_categories;
